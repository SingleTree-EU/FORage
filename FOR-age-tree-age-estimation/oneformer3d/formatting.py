...
class Pack3DDetInputs_(Pack3DDetInputs):
    ...
    def pack_single_results(self, results: dict) -> dict:
        ...
        for key in [
                ...
                'elastic_coords', 'centers_2d', 'depths', 'gt_labels_3d', 'species_label', 'age_label','dbh_label' ,'height_label'
        ]:
        ...
        if 'pts_path' in results:
            packed_results['pts_path'] = results['pts_path']

        packed_results['data_samples'].pts_path = results['pts_path']
