...
from forage_data_utils import forageData
...
def create_info_file(data_path,
                        ...
                        save_path=None,
                        workers=4):
    """Create forage dataset information file.
    ...
    if pkl_prefix == 'forage':
        # ScanNet has a train-val-test split
        train_dataset = forageData(root_path=data_path, split='train')
        val_dataset = forageData(root_path=data_path, split='val')
        test_dataset = forageData(root_path=data_path, split='test')
