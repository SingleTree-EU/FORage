...
from converter_forage import create_info_file
from update_infos_to_v2 import update_pkl_infos


def forage_data_prep(root_path, info_prefix, out_dir, workers):
...
parser.add_argument('dataset', metavar='forage', help='name of the dataset')
parser.add_argument(
    '--root-path',
    type=str,
    default='./data/forage',
...
parser.add_argument('--extra-tag', type=str, default='forage')
parser.add_argument(
